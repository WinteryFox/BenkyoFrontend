...
export default function Input(props: {
    ...
    return (
        <>
            ...
            <input
                className={`${props.error ? "border-red-500" : ""} shadow appearance-none border rounded-3xl w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline focus:border-primary-500 transition-colors duration-150`}
